...
class Event2Mind(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        target_embedding_dim = (
            target_embedding_dim or self._source_embedder.get_output_dim()
        )
    ...
    def _update_recall(
        ...
        target_recall(
            all_top_k_predictions, relevant_targets, relevant_mask, self._end_index
        )
        ...
        **target_tokens: Dict[str, TextFieldTensors],
        ...
        if not self.training:
            ...
            for name, state in self._states.items():
                ...
                if target_tokens:
                    self._update_recall(
                        all_top_k_predictions, target_tokens[name], state.recall
                    )
